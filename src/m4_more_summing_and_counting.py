...
def run_test_factorial():
    ...
    # Test 5:
    answer_from_formula = 6
    answer_from_my_code = factorial(3)
    print('Test 5 expected (from by-hand):', answer_from_formula)
    print('       actual (from my code): ', answer_from_my_code)
...
def run_test_count_cosines_from():
    ...
    # Test 3:
    expected = 3
    answer = count_cosines_from(2, 8, 0)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 0
    answer = count_cosines_from(1, 4, 5)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 2.92896  # This is APPROXIMATELY the correct answer.
